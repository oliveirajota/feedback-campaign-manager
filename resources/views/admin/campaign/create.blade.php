                    ...
                    <form data-parsley-validate class="form-horizontal form-label-left" action="{{ route('campaigns.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::select('company_id', $companies, null, ['class' => 'form-control col-md-7 col-xs-12']) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::text('start_at', null, ['class' => 'form-control col-md-7 col-xs-12 datepicker']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::text('expire_at', null, ['class' => 'form-control col-md-7 col-xs-12 datepicker']) }}
